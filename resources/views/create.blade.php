...
@section('content')
    ...
    @endif
            ...
            <input class="form-control"name="district" type="text" id="district" size="40"  placeholder=" bentivi" required value="{{$adresses->district  ?? ''}}" ></imput>
            ...
            <div class="col-12">
                <button type="submit" class="btn btn-primary btn-lg" value="">@if(isset($clients))EDITAR @else Cadastrar @endif</button>
            </div>
            </form>
